...
class FrameModel(object):
    ...
    Args
        ...
        feature_vector: List of length 33 * 33 = 441 containing the angles between all connections
    """
    def __init__(self, landmarks: List[float]):

        # Define the POSE connections
        self.connections = mp.solutions.holistic.POSE_CONNECTIONS
    ...
    def _get_feature_vector(self, landmarks: np.ndarray) -> List[float]:
        """
        Params
            landmarks: numpy array of shape (33, 3)
        Return
    ...
    def _get_connections_from_landmarks(
        ...
        Params
            landmarks: numpy array of shape (33, 3)
        Return
            List of vectors representing pose connections
        """
        return list(
            map(
